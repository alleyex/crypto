...
- admin queue summary now exposes per-job-type counts, failure/attempt metrics, retry counts, failure streaks, per-job-type latest failed/retried markers, overall latest failed/retried job details, and filterable recent jobs
