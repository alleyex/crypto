...
- admin queue summary now exposes per-job-type counts, failure/attempt metrics, retry counts, failure streaks, latest failed/retried job details, and filterable recent jobs
